                  ...
                  <div class="row ">
                        <div class="col-12 col-md-6 text-center position-relative">
                              <div class="text-center">
                                    ...
                                    <div class="z-3 position-absolute top-30 start-50 rounded-3 text-center ">
                                          <img class="animate__animated animate__backInLeft" src="img/foto.png" style="width: 300px;" alt="">
                                    </div>
                                    <div class="z-2 position-absolute animate__animated animate__rotateIn pt-2 mt-2 ">
                                    ...
                                    <div class=" z-1 position-absolute animate__animated animate__rotateIn pt-2 mt-2 ">
                                          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" width="700" height="700">
